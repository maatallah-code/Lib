...
import com.maatallah.lib.databinding.CountryListBinding
import com.maatallah.lib.databinding.PhoneNumberPickerBinding
import com.maatallah.lib.models.Country
import com.maatallah.lib.adapters.CountryAdapter
import com.maatallah.lib.adapters.OnCountrySelected
import com.maatallah.lib.models.Continent
import com.maatallah.lib.utils.CountryFactory
import com.maatallah.lib.utils.disableCopyPaste
import java.util.*
...
class PhoneNumberPicker(context: Context, private val attrs: AttributeSet?) : LinearLayout(context, attrs),
    ...
    companion object {
        ...
        const val DEFAULT_COUNTRY_KEY = "sa"
